            ...
            <div class="row" id="ft-links">
                  ...
                  <div class="position-relative">
                     ...
                     <div class="d-lg-block collapse show" id="collapseLanding" data-bs-parent="#ft-links" style="">
                        ...
                        <ul class="list-unstyled mb-0 py-3 py-lg-0">
                           <li class="mb-2">
                              <a href=".#!" class="text-decoration-none text-reset">Bitcoin</a>
                           </li>
                           <li class="mb-2">
                              <a href="#!" class="text-decoration-none text-reset">Exchange</a>
                           </li>
                           <li class="mb-2">
                              <a href="#!" class="text-decoration-none text-reset">Buy Crypto</a>
                           </li>
                           <li class="mb-2">
               ...
               <div class="col-lg-3 col-12">
                  ...
                  <div class="collapse d-lg-block" id="collapseLocations" data-bs-parent="#ft-links">
                     <ul class="list-unstyled mb-0 py-3 py-lg-0">
                        <li class="mb-2">
                           <a href="./docs/index.html" class="text-decoration-none text-reset">Legal</a>
                        </li>
                        <li class="mb-2">
                           <a href="#!" class="text-decoration-none text-reset">Terms and condition</a>
                        </li>
                        <li class="mb-2">
                           <a href="./changelog.html" class="text-decoration-none text-reset">Privacy notice</a>
                        </li>
                        <li class="mb-2">
   ...
   <div class="container mt-7 pt-lg-7 pb-4">
      <div class="row align-items-center">
         <div class="col-md-3">
            <a class="mb-4 mb-lg-0 d-block text-inverse" href="<?= PROOT; ?>index"><img src="assets/media/logo.svg" width="35" height="35" alt="" /></a>
         </div>
